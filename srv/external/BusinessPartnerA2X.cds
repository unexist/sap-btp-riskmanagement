/* checksum : b87d22ce3c4400ac3f592da7158a2267 */
@cds.external : true
...
entity BusinessPartnerA2X.A_BPCreditWorthiness {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPDataController {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPFinancialServicesExtn {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPFinancialServicesReporting {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPFiscalYearInformation {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPIntlAddressVersion {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
entity BusinessPartnerA2X.A_BPRelationship {
  @sap.display.format : 'UpperCase'
  @sap.label : 'BP Relationship No.'
  @sap.quickinfo : 'BP Relationship Number'
  key RelationshipNumber : String(12) not null;
...
entity BusinessPartnerA2X.A_BusinessPartner {
  ...
  TradingPartner : String(6);
  @cds.ambiguous : 'missing on condition?'
  to_BPCreditWorthiness : Association to BusinessPartnerA2X.A_BPCreditWorthiness {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPDataController : Association to many BusinessPartnerA2X.A_BPDataController {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPFinServicesReporting : Association to BusinessPartnerA2X.A_BPFinancialServicesReporting {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPFiscalYearInformation : Association to many BusinessPartnerA2X.A_BPFiscalYearInformation {  };
  @cds.ambiguous : 'missing on condition?'
  to_BPRelationship : Association to many BusinessPartnerA2X.A_BPRelationship {  };
  @cds.ambiguous : 'missing on condition?'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartner : Association to BusinessPartnerA2X.A_BPFinancialServicesExtn {  };
  @cds.ambiguous : 'missing on condition?'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_BusinessPartnerRating : Association to many BusinessPartnerA2X.A_BusinessPartnerRating {  };
  @cds.ambiguous : 'missing on condition?'
  ...
  @cds.ambiguous : 'missing on condition?'
  to_PaymentCard : Association to many BusinessPartnerA2X.A_BusinessPartnerPaymentCard {  };
  @cds.ambiguous : 'missing on condition?'
...
entity BusinessPartnerA2X.A_BusinessPartnerAddress {
  ...
  @cds.ambiguous : 'missing on condition?'
  to_BPIntlAddressVersion : Association to many BusinessPartnerA2X.A_BPIntlAddressVersion {  };
  @cds.ambiguous : 'missing on condition?'
  to_EmailAddress : Association to many BusinessPartnerA2X.A_AddressEmailAddress {  };
  @cds.ambiguous : 'missing on condition?'
  to_FaxNumber : Association to many BusinessPartnerA2X.A_AddressFaxNumber {  };
...
entity BusinessPartnerA2X.A_BusinessPartnerPaymentCard {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
...
@sap.content.version : '1'
@sap.label : 'Ratings'
entity BusinessPartnerA2X.A_BusinessPartnerRating {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Business Partner'
  @sap.quickinfo : 'Business Partner Number'
  key BusinessPartner : String(10) not null;
